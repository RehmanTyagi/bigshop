...
const SignUp = () => {
    return (
        <div className="h-dvh sm:block lg:grid grid-cols-[auto,600px]">
            <div className="bg-gray-400 max-sm:hidden"><img className="h-full w-full" src="loginPage.jpeg" /></div>
            <div className="grid place-items-center h-full">
                <div className="grid gap-3 px-20 py-5 max-sm:px-5 max-sm:gap-4">
                    ...
                    <Button className="flex  justify-center items-center text-white"><BeatLoader color="white" size={15} /></Button>
